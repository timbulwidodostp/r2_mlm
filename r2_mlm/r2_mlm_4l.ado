program r2_mlm_4L, rclass sortpreserve
	version 17
	syntax [, ]
	...
	if mi("`fvlist'") {
		...
		foreach var of varlist `fvfvlist' {
			...
			cap egen double `v`i'_2m' = mean(`var') if e(sample), by(`id4' `id3' `id2')
			cap egen double `v`i'_3m' = mean(`var') if e(sample), by(`id4' `id3')
			cap egen double `v`i'_4m' = mean(`var') if e(sample), by(`id4')
		...
		if "`ccheck2'"=="_cons" {
			...
			if `rcheck2'==1 {
				...
				foreach var of varlist `fvrvlist2' {
					...
					cap egen double `v`i'_2m2' = mean(`var') if e(sample), by(`id4' `id3' `id2')
					cap egen double `v`i'_3m2' = mean(`var') if e(sample), by(`id4' `id3')
					cap egen double `v`i'_4m2' = mean(`var') if e(sample), by(`id4')
		...
		if "`ccheck3'"=="_cons" {
			...
			if `rcheck3'==1 {
				...
				foreach var of varlist `fvrvlist3' {
					...
					cap egen double `v`i'_2m3' = mean(`var') if e(sample), by(`id4' `id3' `id2')
					cap egen double `v`i'_3m3' = mean(`var') if e(sample), by(`id4' `id3')
					cap egen double `v`i'_4m3' = mean(`var') if e(sample), by(`id4')
		...
		if "`ccheck4'"=="_cons" {
			...
			if `rcheck4'==1 {
				...
				foreach var of varlist `fvrvlist4' {
					...
					cap egen double `v`i'_2m4' = mean(`var') if e(sample), by(`id4' `id3' `id2')
					cap egen double `v`i'_3m4' = mean(`var') if e(sample), by(`id4' `id3')
					cap egen double `v`i'_4m4' = mean(`var') if e(sample), by(`id4')
	...
	if (`R2_v22_2' >= 10^-5 & !mi(`R2_v22_2')) | (`R2_v32_3' >= 10^-5 & !mi(`R2_v32_3')) | (`R2_v33_3' >= 10^-5 & !mi(`R2_v33_3')) | (`R2_v42_4' >= 10^-5 & !mi(`R2_v42_4')) | (`R2_v43_4' >= 10^-5 & !mi(`R2_v43_4')) | (`R2_v44_4' >= 10^-5 & !mi(`R2_v44_4')) {
	...
	if wordcount("`fvlist'")>0 & !mi("`fvlist'") {
		...
		foreach var of varlist `fvfvlist' {
			...
			sca `v`i'_2var' = r(Var)
			loc v`i'_2vc = 0
			if `v`i'_2var'>=10^-8 & !mi(`v`i'_2var') {
				loc v`i'_2vc = 1
			}
			qui su `v`i'_3' if e(sample)
			sca `v`i'_3var' = r(Var)
			loc v`i'_3vc = 0
			if `v`i'_3var'>=10^-8 & !mi(`v`i'_3var') {
				loc v`i'_3vc = 1
			}
			qui su `v`i'_4m' if e(sample)
			sca `v`i'_4mvar' = r(Var)
			loc v`i'_4mvc = 0
			if `v`i'_4mvar'>=10^-8 & !mi(`v`i'_4mvar') {
				loc v`i'_4mvc = 1
			}
			if `v`i'_1vc'==1 & `v`i'_2vc'==1 & `v`i'_3vc'==0 & `v`i'_4mvc'==0 {
				loc unconf2m = 0
			...
			if (`v`i'_1vc'==1 & `v`i'_2vc'==0 & `v`i'_3vc'==1 & `v`i'_4mvc'==0) | (`v`i'_1vc'==0 & `v`i'_2vc'==1 & `v`i'_3vc'==1 & `v`i'_4mvc'==0)  {
				loc unconf3m = 0
				if wordcount("`fvlist'")>1 {
					loc vc = word("`fvfvlist'",`i')
					loc complist : list fvfvlist - vc
			...
			if (`v`i'_1vc'==1 & `v`i'_2vc'==0 & `v`i'_3vc'==0 & `v`i'_4mvc'==1) | (`v`i'_1vc'==0 & `v`i'_2vc'==1 & `v`i'_3vc'==0 & `v`i'_4mvc'==1) | (`v`i'_1vc'==0 & `v`i'_2vc'==0 & `v`i'_3vc'==1 & `v`i'_4mvc'==1) {
				loc unconf4m = 0
				if wordcount("`fvlist'")>1 {
					loc vc = word("`fvfvlist'",`i')
					loc complist : list fvfvlist - vc
			...
			if (`v`i'_1vc'==0 & `v`i'_2vc'==1 & `v`i'_3vc'==1 & `v`i'_4mvc'==1) | (`v`i'_1vc'==1 & `v`i'_2vc'==0 & `v`i'_3vc'==1 & `v`i'_4mvc'==1) {
				loc unconf3m = 0
				loc unconf3 = 0
				loc unconf4m = 0
				if wordcount("`fvlist'")>1 {
					...
					foreach fv of varlist `complist' {
						...
						if `diff`i'_3m_var'<10^-8 {
							loc unconf3m = `unconf3m'+1
						}
						if `diff`i'_3_var'<10^-8 {
							loc unconf3 = `unconf3'+1
						}
						if `diff`i'_4m_var'<10^-8 {
							loc unconf4m = `unconf4m'+1
						}
					}
				}
			...
			if `v`i'_1vc'==1 & `v`i'_2vc'==1 & `v`i'_3vc'==0 & `v`i'_4mvc'==1 {
				loc unconf2m = 0
				loc unconf2 = 0
				loc unconf4m = 0
				if wordcount("`fvlist'")>1 {
					...
					foreach fv of varlist `complist' {
						...
						qui su `diff`i'_4m' if e(sample)
						sca `diff`i'_4m_var' = r(Var)
						if `diff`i'_2m_var'<10^-8 {
							loc unconf2m = `unconf2m'+1
						}
						if `diff`i'_2_var'<10^-8 {
			...
			if `v`i'_1vc'==1 & `v`i'_2vc'==1 & `v`i'_3vc'==1 & `v`i'_4mvc'==0 {
				loc unconf2m = 0
				loc unconf2 = 0
				loc unconf3m = 0
				if wordcount("`fvlist'")>1 {
			...
			if `v`i'_1vc'==1 & `v`i'_2vc'==1 & `v`i'_3vc'==1 & `v`i'_4mvc'==1 {
				loc unconf2m = 0
				loc unconf2 = 0
				loc unconf3m = 0
				loc unconf3 = 0
	...
	forvalues q = 2/4 {
		if wordcount("`rvlist`q''")>0 & !mi("`rvlist`q''") {
			...
			foreach var of varlist `fvrvlist`q'' {
				tempname v`i'_1`q'var v`i'_2`q'var v`i'_3`q'var v`i'_4m`q'var
				qui su `v`i'_1`q'' if e(sample)
				sca `v`i'_1`q'var' = r(Var)
				loc v`i'_1`q'vc = 0
				if `v`i'_1`q'var'>=10^-8 & !mi(`v`i'_1`q'var') {
					loc v`i'_1`q'vc = 1
				}
				qui su `v`i'_2`q'' if e(sample)
				sca `v`i'_2`q'var' = r(Var)
				loc v`i'_2`q'vc = 0
				if `v`i'_2`q'var'>=10^-8 & !mi(`v`i'_2`q'var') {
					loc v`i'_2`q'vc = 1
				}
				qui su `v`i'_3`q'' if e(sample)
				sca `v`i'_3`q'var' = r(Var)
				loc v`i'_3`q'vc = 0
				if `v`i'_3`q'var'>=10^-8 & !mi(`v`i'_3`q'var') {
					loc v`i'_3`q'vc = 1
				}
				qui su `v`i'_4m`q'' if e(sample)
				sca `v`i'_4m`q'var' = r(Var)
				loc v`i'_4m`q'vc = 0
				if `v`i'_4m`q'var'>=10^-8 & !mi(`v`i'_4m`q'var') {
					loc v`i'_4m`q'vc = 1
				}
				if `v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==0 & `v`i'_4m`q'vc'==0 {
					loc unconf2m`q' = 0
				...
				if (`v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==0 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==0) | (`v`i'_1`q'vc'==0 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==0)  {
					loc unconf3m`q' = 0
					if wordcount("`rvlist`q''")>1 {
						loc vc`q' = word("`fvrvlist`q''",`i')
						loc complist`q' : list fvrvlist`q' - vc`q'
				...
				if (`v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==0 & `v`i'_3`q'vc'==0 & `v`i'_4m`q'vc'==1) | (`v`i'_1`q'vc'==0 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==0 & `v`i'_4m`q'vc'==1) | (`v`i'_1`q'vc'==0 & `v`i'_2`q'vc'==0 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==1) {
					loc unconf4m`q' = 0
					if wordcount("`rvlist`q''")>1 {
						loc vc`q' = word("`fvrvlist`q''",`i')
						loc complist`q' : list fvrvlist`q' - vc`q'
				...
				if (`v`i'_1`q'vc'==0 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==1) | (`v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==0 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==1) {
					loc unconf3m`q' = 0
					loc unconf3_`q' = 0
					loc unconf4m`q' = 0
					if wordcount("`rvlist`q''")>1 {
						...
						foreach rv`q' of varlist `complist`q'' {
							...
							if `diff`q'_`i'_3m_var'<10^-8 {
								loc unconf3m`q' = `unconf3m`q''+1
							}
							if `diff`q'_`i'_3_var'<10^-8 {
								loc unconf3_`q' = `unconf3_`q''+1
							}
							if `diff`q'_`i'_4m_var'<10^-8 {
								loc unconf4m`q' = `unconf4m`q''+1
							}
						}
					}
				...
				if `v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==0 & `v`i'_4m`q'vc'==1 {
					loc unconf2m`q' = 0
					loc unconf2_`q' = 0
					loc unconf4m`q' = 0
					if wordcount("`rvlist`q''")>1 {
						...
						foreach rv`q' of varlist `complist`q'' {
							...
							qui su `diff`q'_`i'_4m' if e(sample)
							sca `diff`q'_`i'_4m_var' = r(Var)
							if `diff`q'_`i'_2m_var'<10^-8 {
								loc unconf2m`q' = `unconf2m`q''+1
							}
							if `diff`q'_`i'_2_var'<10^-8 {
				...
				if `v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==0 {
					loc unconf2m`q' = 0
					loc unconf2_`q' = 0
					loc unconf3m`q' = 0
					if wordcount("`rvlist`q''")>1 {
				...
				if `v`i'_1`q'vc'==1 & `v`i'_2`q'vc'==1 & `v`i'_3`q'vc'==1 & `v`i'_4m`q'vc'==1 {
					loc unconf2m`q' = 0
					loc unconf2_`q' = 0
					loc unconf3m`q' = 0
					loc unconf3_`q' = 0
	...
	if `R2_v32_3'<10^-8 & !mi(`R2_v32_3') {
		sca `R2_v32_3' = 0
	}
	if `R2_v33_3'<10^-8 & !mi(`R2_v33_3') {
		sca `R2_v33_3' = 0
	}
	if `R2_v42_4'<10^-8 & !mi(`R2_v42_4') {
		sca `R2_v42_4' = 0
	}
	if `R2_v43_4'<10^-8 & !mi(`R2_v43_4') {
		sca `R2_v43_4' = 0
	}
	if `R2_v44_4'<10^-8 & !mi(`R2_v44_4') {
		sca `R2_v44_4' = 0
	}
	if `R2_v22_t'<10^-8 & !mi(`R2_v22_t') {
		sca `R2_v22_t' = 0
	}
	if `R2_v32_t'<10^-8 & !mi(`R2_v32_t') {
		sca `R2_v32_t' = 0
	}
	if `R2_v33_t'<10^-8 & !mi(`R2_v33_t') {
		sca `R2_v33_t' = 0
	}
	if `R2_v42_t'<10^-8 & !mi(`R2_v42_t') {
		sca `R2_v42_t' = 0
	}
	if `R2_v43_t'<10^-8 & !mi(`R2_v43_t') {
		sca `R2_v43_t' = 0
	}
	if `R2_v44_t'<10^-8 & !mi(`R2_v44_t') {
		sca `R2_v44_t' = 0
	}
	ret clear
	...
	mat colnames `R2' = r2f1_1 r2v12_1 r2v13_1 r2v14_1 resid_1 r2f2_2 r2v22_2 r2v23_2 r2v24_2 r2m2_2 r2f3_3 r2v32_3 r2v33_3 r2v34_3 r2m3_3 r2f4_4 r2v42_4 r2v43_4 r2v44_4 r2m4_4 r2f1_t r2f2_t r2f3_t r2f4_t r2v12_t r2v22_t r2v32_t r2v42_t r2v2_t r2v13_t r2v23_t r2v33_t r2v43_t r2v3_t r2v14_t r2v24_t r2v34_t r2v44_t r2v4_t r2m2_t r2m3_t r2m4_t r2f_t r2v_t r2m_t r2fv_t r2fvm_t resid_t
	mat rownames `R2' = "`dv'"
	ret mat R2 = `R2'
	qui _estimates unhold mixedest
	qui _estimates hold mixedest, copy restore
	...
	ret sca r2m4_t = `R2_m4_t'
	ret sca r2m3_t = `R2_m3_t'
	ret sca r2m2_t = `R2_m2_t'
	ret sca r2v4_t = `R2_v4_t'
	ret sca r2v44_t = `R2_v44_t'
	ret sca r2v34_t = `R2_v34_t'
	ret sca r2v24_t = `R2_v24_t'
	ret sca r2v14_t = `R2_v14_t'
	ret sca r2v3_t = `R2_v3_t'
	ret sca r2v43_t = `R2_v43_t'
	ret sca r2v33_t = `R2_v33_t'
	ret sca r2v23_t = `R2_v23_t'
	ret sca r2v13_t = `R2_v13_t'
	ret sca r2v2_t = `R2_v2_t'
	ret sca r2v42_t = `R2_v42_t'
	ret sca r2v32_t = `R2_v32_t'
	ret sca r2v22_t = `R2_v22_t'
	ret sca r2v12_t = `R2_v12_t'
	ret sca r2f4_t = `R2_f4_t'
	ret sca r2f3_t = `R2_f3_t'
	ret sca r2f2_t = `R2_f2_t'
	ret sca r2f1_t = `R2_f1_t'
	ret sca r2m4_4 = `R2_m4_4'
	ret sca r2v44_4 = `R2_v44_4'
	ret sca r2v43_4 = `R2_v43_4'
	ret sca r2v42_4 = `R2_v42_4'
	ret sca r2f4_4 = `R2_f4_4'
	ret sca r2m3_3 = `R2_m3_3'
	ret sca r2v34_3 = `R2_v34_3'
	ret sca r2v33_3 = `R2_v33_3'
	ret sca r2v32_3 = `R2_v32_3'
	ret sca r2f3_3 = `R2_f3_3'
	ret sca r2m2_2 = `R2_m2_2'
	ret sca r2v24_2 = `R2_v24_2'
	ret sca r2v23_2 = `R2_v23_2'
	ret sca r2v22_2 = `R2_v22_2'
	ret sca r2f2_2 = `R2_f2_2'
	ret sca resid_1 = `Resid_1'
	ret sca r2v14_1 = `R2_v14_1'
	ret sca r2v13_1 = `R2_v13_1'
	ret sca r2v12_1 = `R2_v12_1'
	ret sca r2f1_1 = `R2_f1_1'
	ret sca r2L4_t = `R2_L4_t'
	ret sca r2L3_t = `R2_L3_t'
