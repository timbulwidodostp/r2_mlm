program r2_mlm_3L, rclass sortpreserve
	version 17
	syntax [, ]
	...
	if (`R2_v22_2' >= 10^-5 & !mi(`R2_v22_2')) | (`R2_v32_3' >= 10^-5 & !mi(`R2_v32_3')) | (`R2_v33_3' >= 10^-5 & !mi(`R2_v33_3')) {
	...
	if wordcount("`fvlist'")>0 & !mi("`fvlist'") {
		...
		foreach var of varlist `fvfvlist' {
			...
			loc v`i'_3mvc = 0
			if `v`i'_3mvar'>=10^-8 & !mi(`v`i'_3mvar') {
				loc v`i'_3mvc = 1
			}
	...
	forvalues q = 2/3 {
		if wordcount("`rvlist`q''")>0 & !mi("`rvlist`q''") {
			...
			foreach var of varlist `fvrvlist`q'' {
				...
				loc v`i'_3m`q'vc = 0
				if `v`i'_3m`q'var'>=10^-8 & !mi(`v`i'_3m`q'var') {
					loc v`i'_3m`q'vc = 1
				}
	...
	mat colnames `R2' = r2f1_1 r2v12_1 r2v13_1 resid_1 r2f2_2 r2v22_2 r2v23_2 r2m2_2 r2f3_3 r2v32_3 r2v33_3 r2m3_3 r2f1_t r2f2_t r2f3_t r2v12_t r2v22_t r2v32_t r2v2_t r2v13_t r2v23_t r2v33_t r2v3_t r2m2_t r2m3_t r2f_t r2v_t r2m_t r2fv_t r2fvm_t resid_t
	mat rownames `R2' = "`dv'"
	ret mat R2 = `R2'
	qui _estimates unhold mixedest
	qui _estimates hold mixedest, copy restore
