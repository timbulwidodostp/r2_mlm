program r2_mlm_5L, rclass sortpreserve
	version 17
	syntax [, ]
	...
	if (`R2_v22_2' >= 10^-5 & !mi(`R2_v22_2')) | (`R2_v32_3' >= 10^-5 & !mi(`R2_v32_3')) | (`R2_v33_3' >= 10^-5 & !mi(`R2_v33_3')) | (`R2_v42_4' >= 10^-5 & !mi(`R2_v42_4')) | (`R2_v43_4' >= 10^-5 & !mi(`R2_v43_4')) | (`R2_v44_4' >= 10^-5 & !mi(`R2_v44_4')) | (`R2_v52_5' >= 10^-5 & !mi(`R2_v52_5')) | (`R2_v53_5' >= 10^-5 & !mi(`R2_v53_5')) | (`R2_v54_5' >= 10^-5 & !mi(`R2_v54_5')) | (`R2_v55_5' >= 10^-5 & !mi(`R2_v55_5')) {
	...
	if wordcount("`fvlist'")>0 & !mi("`fvlist'") {
		...
		foreach var of varlist `fvfvlist' {
			...
			sca `v`i'_4var' = r(Var)
			loc v`i'_4vc = 0
			if `v`i'_4var'>=10^-8 & !mi(`v`i'_4var') {
				loc v`i'_4vc = 1
			}
			qui su `v`i'_5m' if e(sample)
			sca `v`i'_5mvar' = r(Var)
			loc v`i'_5mvc = 0
			if `v`i'_5mvar'>=10^-8 & !mi(`v`i'_5mvar') {
				loc v`i'_5mvc = 1
			}
	...
	forvalues q = 2/5 {
		if wordcount("`rvlist`q''")>0 & !mi("`rvlist`q''") {
			...
			foreach var of varlist `fvrvlist`q'' {
				...
				loc v`i'_4`q'vc = 0
				if `v`i'_4`q'var'>=10^-8 & !mi(`v`i'_4`q'var') {
					loc v`i'_4`q'vc = 1
				}
				qui su `v`i'_5m`q'' if e(sample)
				sca `v`i'_5m`q'var' = r(Var)
				loc v`i'_5m`q'vc = 0
				if `v`i'_5m`q'var'>=10^-8 & !mi(`v`i'_5m`q'var') {
					loc v`i'_5m`q'vc = 1
				}
	...
	if `R2_v52_5'<10^-8 & !mi(`R2_v52_5') {
		sca `R2_v52_5' = 0
	}
	if `R2_v53_5'<10^-8 & !mi(`R2_v53_5') {
		sca `R2_v53_5' = 0
	}
	if `R2_v54_5'<10^-8 & !mi(`R2_v54_5') {
		sca `R2_v54_5' = 0
	}
	if `R2_v55_5'<10^-8 & !mi(`R2_v55_5') {
		sca `R2_v55_5' = 0
	}
	...
	if `R2_v52_t'<10^-8 & !mi(`R2_v52_t') {
		sca `R2_v52_t' = 0
	}
	if `R2_v53_t'<10^-8 & !mi(`R2_v53_t') {
		sca `R2_v53_t' = 0
	}
	if `R2_v54_t'<10^-8 & !mi(`R2_v54_t') {
		sca `R2_v54_t' = 0
	}
	if `R2_v55_t'<10^-8 & !mi(`R2_v55_t') {
		sca `R2_v55_t' = 0
	}
	ret clear
	...
	mat colnames `R2' = r2f1_1 r2v12_1 r2v13_1 r2v14_1 r2v15_1 resid_1 r2f2_2 r2v22_2 r2v23_2 r2v24_2 r2v25_2 r2m2_2 r2f3_3 r2v32_3 r2v33_3 r2v34_3 r2v35_3 r2m3_3 r2f4_4 r2v42_4 r2v43_4 r2v44_4 r2v45_4 r2m4_4 r2f5_5 r2v52_5 r2v53_5 r2v54_5 r2v55_5 r2m5_5 r2f1_t r2f2_t r2f3_t r2f4_t r2f5_t r2v12_t r2v22_t r2v32_t r2v42_t r2v52_t r2v2_t r2v13_t r2v23_t r2v33_t r2v43_t r2v53_t r2v3_t r2v14_t r2v24_t r2v34_t r2v44_t r2v54_t r2v4_t r2v15_t r2v25_t r2v35_t r2v45_t r2v55_t r2v5_t r2m2_t r2m3_t r2m4_t r2m5_t r2f_t r2v_t r2m_t r2fv_t r2fvm_t resid_t
	mat rownames `R2' = "`dv'"
	ret mat R2 = `R2'
	qui _estimates unhold mixedest
	qui _estimates hold mixedest, copy restore
